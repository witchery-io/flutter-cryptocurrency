...
class Eos implements Coin {
  ...
  @override
  String getPublicKey() {
    return eos_ecc.EOSPrivateKey.fromBuffer(_hdWallet.privateKey).toEOSPublicKey().toString();
  }
  ...
  Future<String> getAddress() async {
    eos_io.EOSClient client = eos_io.EOSClient('https://api.jungle.alohaeos.com', 'v1');
